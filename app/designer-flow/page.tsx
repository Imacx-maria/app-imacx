      ...
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            GESTÃO DE PROPOSTAS, APROVAÇÕES, PAGINAÇÃO E PLANOS DE PRODUÇÃO POR
            FOLHA DE OBRA.
          </p>
        </div>
                ...
                <Table className="w-full imx-table-compact">
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead
                        className="sticky top-0 z-10 w-[90px] cursor-pointer imx-border-b select-none"
                      ...
                      <TableHead
                        className="sticky top-0 z-10 w-[180px] cursor-pointer imx-border-b select-none"
                      ...
                      paginatedJobs.map((job) => (
                        ...
                        >
                          ...
                          <TableCell className="w-[90px]">
                            {job.numero_orc
                              ? String(job.numero_orc).slice(0, 6)
                              : ""}
                          </TableCell>
                          <TableCell
                            className="w-[180px]"
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between imx-border-t  pt-4">
                <div className="text-sm text-muted-foreground">
                  Página {currentPage} de {totalPages} ({sortedJobs.length}{" "}
                  trabalhos)
                </div>
                <div className="flex items-center gap-2">
                  <Button
      ...
      >
        <DrawerContent className="flex flex-col max-h-[85vh]">
          <DrawerHeader className="flex-shrink-0">
            <DrawerTitle>
              Design Items - FO {selectedJob?.numero_fo} / ORC{" "}
              {selectedJob?.numero_orc}
            </DrawerTitle>
            ...
            {jobItems.length === 0 ? (
              ...
              jobItems.map((item, index) => (
                <DesignerItemCard
                  ...
                  onToggle={(open) =>
                    setOpenItemId(open ? item.designer_item_id : null)
                  }
