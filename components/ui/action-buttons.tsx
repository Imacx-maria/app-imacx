...
export const ViewButton = React.forwardRef<HTMLButtonElement, ActionButtonProps>(
  ({ onClick, disabled, className, size = 16 }, ref) => {
    return (
      <button
        ref={ref}
...
export const TextButton = React.forwardRef<HTMLButtonElement, TextButtonProps>(
  ({ variant = 'default', className, children, ...props }, ref) => {
    const variantStyles = {
      delete: 'bg-destructive text-destructive-foreground border border-black hover:bg-destructive/90',
      edit: 'bg-accent text-accent-foreground border border-black hover:bg-accent/80',
      view: 'bg-primary text-primary-foreground border border-black hover:bg-primary/90',
      default: 'bg-background text-foreground border border-black hover:bg-accent hover:text-accent-foreground',
    }
