...
export const COLUMNS: ColumnConfig[] = [
  {
    ...
    sortable: true,
    align: "center",
    visible: { em_curso: true, pendentes: true, concluidos: true },
  },
  {
    key: "numero_orc",
    label: "ORC",
  ...
  {
    key: "pendente" as SortableJobKey,
    label: "SB",
    tooltip: "Stand By",
    width: "w-[40px]",
    sortable: true,
    align: "center",
    visible: { em_curso: true, pendentes: true, concluidos: false },
  },
  {
    key: "actions" as any,
    label: "Ações",
