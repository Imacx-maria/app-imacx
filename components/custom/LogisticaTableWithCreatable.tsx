...
interface LogisticaTableWithCreatableProps {
  ...
  onTransportadorasUpdate?: (
    newTransportadoras: TransportadoraOption[],
  ) => void;
              ...
              >
                ...
                {!hideColumns?.includes("numero_orc") && (
                  <TableCell className="w-[80px] max-w-[80px] text-sm">
                    <div className={`${staticCellClass} w-full justify-center`}>
                      ...
                      onBlur={() => {
                        ...
                        if (foValue && onFoSave) {
                          ...
                          onFoSave(row, foValue).catch((error) => {
                            console.error("❌ onFoSave on blur failed:", error);
                          });
                        }
                      }}
                      onKeyDown={(e) => {
                      ...
                      <CreatableClienteCombobox
                        ...
                        value={
                          row.items_base?.folhas_obras?.id_cliente
                            ? String(row.items_base?.folhas_obras?.id_cliente)
                            : ""
                        }
                ...
                <TableCell className="w-[90px] max-w-[90px] text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    {(() => {
                      ...
                      const sumQty = itemId
                        ? totalQuantidadePorItemId[itemId]
                        : undefined;
                      const hasMismatch =
                        typeof baseQty === "number" &&
                        typeof sumQty === "number" &&
                        baseQty !== sumQty;
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <span
                                ...
                                aria-label="Aviso quantidade divergente"
                              >
                            ...
                            <TooltipContent>
                              <span>
                                Soma das quantidades (Logística): {sumQty} ≠
                                Quantidade do item: {baseQty}
                              </span>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
