-- =====================================================
-- FIX: Change SECURITY INVOKER to SECURITY DEFINER
-- =====================================================
-- Issue: get_department_escaloes_faturas and get_department_conversion_rates
--        are created with SECURITY INVOKER, causing them to fail when
--        authenticated users call them because they can't access phc.ft
-- Solution: Recreate these functions with SECURITY DEFINER
-- =====================================================
...
-- =====================================================
-- 1. GET DEPARTMENT INVOICE BRACKETS (WITH SECURITY DEFINER)
-- =====================================================
...
LANGUAGE plpgsql
SECURITY DEFINER  -- ← FIX: Changed from SECURITY INVOKER
...
-- =====================================================
-- 2. GET DEPARTMENT CONVERSION RATES (WITH SECURITY DEFINER)
-- =====================================================
...
-- =====================================================
-- SELECT * FROM get_department_escaloes_faturas('Brindes', '2025-11-01'::DATE, CURRENT_DATE);
-- SELECT * FROM get_department_conversion_rates('Brindes', '2025-11-01'::DATE, CURRENT_DATE);
