-- Update ONLY the get_department_pipeline function with new date ranges
-- Does NOT touch any tables or departamentos data
...
BEGIN
  ...
  WHERE cq.q_category != 'excluded'
    AND ((cq.q_category = 'top_15' AND cq.category_rank <= 15) OR cq.q_category IN ('needs_attention', 'lost'))
  ORDER BY
    CASE cq.q_category
      WHEN 'top_15' THEN 1
