-- Add MTD (Month-to-Date) support to cost center top customers RPC
-- This allows filtering by both 'ytd' and 'mtd' periods
...
COMMENT ON FUNCTION public.get_cost_center_top_customers IS
  'Returns top N customers per cost center for specified period (mtd or ytd). Uses dynamic date calculations based on CURRENT_DATE.';
