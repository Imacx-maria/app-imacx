-- =====================================================
-- FINAL FIX FOR DEPARTMENT RPC FUNCTIONS
-- =====================================================
-- Issue: Output column names (bracket, days_open) conflict with internal column names
-- Solution: Rename output columns to avoid ambiguity
-- =====================================================
...
-- =====================================================
-- 1. GET DEPARTMENT QUOTE BRACKETS (FINAL FIX)
-- =====================================================
...
RETURNS TABLE (
  value_bracket TEXT,  -- RENAMED from bracket
  quote_count BIGINT,
  total_value NUMERIC,
  percentage NUMERIC
) AS $$
...
-- =====================================================
-- 2. GET DEPARTMENT INVOICE BRACKETS (FINAL FIX)
-- =====================================================
...
-- =====================================================
-- 3. GET DEPARTMENT CONVERSION RATES (FINAL FIX)
-- =====================================================
...
-- =====================================================
-- 4. GET DEPARTMENT PIPELINE (FINAL FIX)
-- =====================================================
...
RETURNS TABLE (
  ...
  customer_name TEXT,
  quote_value NUMERIC,
  quote_status TEXT,  -- RENAMED from status
  quote_days_open INTEGER,  -- RENAMED from days_open
  quote_category TEXT  -- RENAMED from category
) AS $$
BEGIN
  RETURN QUERY
  WITH department_quotes AS (
