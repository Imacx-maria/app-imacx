-- Migration: Fix search_path syntax (was quoted incorrectly)
-- Date: 2025-12-03
-- The previous migration used 'public, phc' (with quotes) which is invalid
-- Correct syntax is: SET search_path = public, phc (no quotes)
